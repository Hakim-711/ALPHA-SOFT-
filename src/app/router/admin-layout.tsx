...
function resolveTopbarCopy(pathname: string) {
  ...
  if (pathname.startsWith('/sales-invoices')) {
    return {
      eyebrow: 'المبيعات / فواتير البيع',
      title: 'إدارة فواتير البيع',
    }
  }

  if (pathname.startsWith('/suppliers')) {
    return {
      eyebrow: 'المشتريات / الموردون',
  ...
  if (pathname.startsWith('/purchase-orders')) {
    return {
      eyebrow: 'المشتريات / أوامر الشراء',
      title: 'إدارة أوامر الشراء',
    }
  }

  if (pathname.startsWith('/purchase-invoices')) {
    return {
      eyebrow: 'المشتريات / فواتير الشراء',
      title: 'إدارة فواتير الشراء',
    }
  }

  if (pathname.startsWith('/daily-cash')) {
    return {
  ...
  if (pathname.startsWith('/statements')) {
    return {
      eyebrow: 'المالية / كشوف الحساب',
      title: 'كشوف حساب العملاء والموردين',
    }
  }

  if (pathname.startsWith('/disbursements')) {
    return {
  ...
  if (pathname.startsWith('/stock-reconciliations')) {
    return {
      eyebrow: 'التشغيل / الجرد والتسوية',
      title: 'إدارة الجرد وتسوية المخزون',
    }
  }

  if (pathname.startsWith('/stock')) {
    return {
      eyebrow: 'التشغيل / حركات المخزون',
      title: 'إدارة حركات المخزون',
    }
  }

  if (pathname.startsWith('/reports')) {
    return {
      eyebrow: 'التشغيل / التقارير',
