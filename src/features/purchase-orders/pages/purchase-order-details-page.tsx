          ...
          <>
            ...
            {order.docstatus === 0 && canUsePermission(permissions.canSubmit) ? (
              <ConfirmActionButton
                ...
                confirmMessage="سيتم اعتماد أمر الشراء داخل ERPNext، وبعدها يدخل في دورة الاستلام والفوترة."
                confirmTitle="اعتماد أمر الشراء؟"
            ...
            {order.docstatus === 1 && canUsePermission(permissions.canCancel) ? (
              <ConfirmActionButton
                ...
                confirmMessage="إلغاء أمر الشراء إجراء حساس وقد يؤثر على علاقته بالاستلام والفواتير."
                confirmTitle="إلغاء أمر الشراء؟"
