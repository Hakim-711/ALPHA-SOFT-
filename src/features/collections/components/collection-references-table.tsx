...
import type { CollectionReference } from '../types/collection.types'

interface CollectionReferencesTableProps {
  rows: CollectionReference[]
}

export function CollectionReferencesTable({ rows }: CollectionReferencesTableProps) {
  const columns: DataColumn<CollectionReference>[] = [
    {
      key: 'reference_name',
      header: 'الفاتورة',
