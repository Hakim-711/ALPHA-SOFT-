...
import type { PurchaseInvoicePaymentSchedule } from '../types/purchase-invoice.types'

export function PurchaseInvoicePaymentScheduleTable({ rows }: { rows: PurchaseInvoicePaymentSchedule[] }) {
  const columns: DataColumn<PurchaseInvoicePaymentSchedule>[] = [
    {
      key: 'due_date',
