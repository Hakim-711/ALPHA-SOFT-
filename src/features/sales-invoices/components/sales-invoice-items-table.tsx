...
import type { SalesInvoiceItem } from '../types/sales-invoice.types'

export function SalesInvoiceItemsTable({ rows }: { rows: SalesInvoiceItem[] }) {
  const columns: DataColumn<SalesInvoiceItem>[] = [
    {
      key: 'item_code',
      header: 'كود الصنف',
